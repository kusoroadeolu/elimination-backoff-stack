 ...
 */
public final class ManesEliminationStack<E> extends AbstractCollection<E> implements ConcurrentStack<E>{
   ...
   */
  public ManesEliminationStack(Collection<? extends E> c) {
    this();
    addAll(c);
  }
  ...
  static class AsLifoQueue<E> extends AbstractQueue<E> implements Queue<E>, Serializable {
    private static final long serialVersionUID = 1L;
    private final ManesEliminationStack<E> stack;

    AsLifoQueue(ManesEliminationStack<E> stack) {
      this.stack = stack;
    }

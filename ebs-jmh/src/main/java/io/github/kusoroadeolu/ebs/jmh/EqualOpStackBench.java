...
* However to still prevent false sharing, we could assign thread local "Slot" which is padded, that will hold the current thread info for an object
* Ideally this will come at the cost of an acquire write,
* but we could piggyback this off the set release write of that slot to the location array to guarantee visibility
*
